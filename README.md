...
<!-- Add a demo GIF or screenshot here for SEO + social previews
![oORecon attack surface discovery TUI — subdomain enumeration and DNS recon](docs/demo.gif)
![oORecon host workspace — JS miner and directory brute-force](docs/workspace.png)
-->
